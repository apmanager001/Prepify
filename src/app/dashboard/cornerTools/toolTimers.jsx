    ...
    <div className="flex justify-center items-center gap-4 flex-wrap w-84">
      ...
      {timers.length > 0 &&
        displayedTimers.map((timer, index) => (
          <div
            key={timer.id ?? index}
            className={`relative rounded-2xl h-${timerHeight} w-${timerWidth} shadow-xl flex flex-col items-center justify-center text-2xl font-bold cursor-auto transition-all duration-300 bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white hover:shadow-2xl hover:scale-105`}
          >
